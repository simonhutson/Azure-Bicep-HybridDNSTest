...
output onPremNatGatewayResourceId string = onPrem.outputs.natGatewayResourceId
output azureNatGatewayResourceId string = azure.outputs.natGatewayResourceId
